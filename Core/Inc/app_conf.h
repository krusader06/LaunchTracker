...
typedef enum
{
  ...
  LT_TASK_SW_INIT,
  LT_TASK_RUN_APPLICATION,
  LT_TASK_CHECK_PMIC,
  LT_TASK_CHECK_BATTERY,
  LT_TASK_HANDLE_DEAD_BAT,
...
typedef enum
{
  ...
  CFG_LPM_LT_APP,	// Launch Tracker Main Application
  CFG_LPM_PMIC,		// Power Management IC
